...
namespace Main.Controls.Old
{
    ...
    /// </summary>
    public partial class ToggleButtonOld2 : UserControl  // System.Windows.Controls.Primitives.ToggleButton
    {
        ...
        public static readonly DependencyProperty IsCheckedProperty = DependencyProperty.Register("IsChecked", typeof(bool), typeof(ToggleButtonOld2), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty TextOffProperty = DependencyProperty.Register("TextOff", typeof(string), typeof(ToggleButtonOld2), new PropertyMetadata(""));
        ...
        public static readonly DependencyProperty TextOnProperty = DependencyProperty.Register("TextOn", typeof(string), typeof(ToggleButtonOld2), new PropertyMetadata(""));
        ...
        public static readonly DependencyProperty ColoreSteloProperty = DependencyProperty.Register("ColoreStelo", typeof(SolidColorBrush), typeof(ToggleButtonOld2), new PropertyMetadata(Util.DammiBrushDaEsadec("FAFAFB")));
        ...
        public static readonly DependencyProperty ColoreSteloOnProperty = DependencyProperty.Register("ColoreSteloOn", typeof(SolidColorBrush), typeof(ToggleButtonOld2), new PropertyMetadata(Util.DammiBrushDaEsadec("52D468")));
        ...
        public static readonly DependencyProperty ColoreSteloDisabledProperty = DependencyProperty.Register("ColoreSteloDisabled", typeof(SolidColorBrush), typeof(ToggleButtonOld2), new PropertyMetadata(Brushes.LightGray));
        ...
        public static readonly DependencyProperty ColoreToggleProperty = DependencyProperty.Register("ColoreToggle", typeof(SolidColorBrush), typeof(ToggleButtonOld2), new PropertyMetadata(Brushes.White));
        ...
        public static readonly DependencyProperty ColoreToggleOnProperty = DependencyProperty.Register("ColoreToggleOn", typeof(SolidColorBrush), typeof(ToggleButtonOld2), new PropertyMetadata(Util.DammiBrushDaEsadec("F7FFF7")));
        ...
        public static readonly DependencyProperty ColoreToggleDisabledProperty = DependencyProperty.Register("ColoreToggleDisabled", typeof(SolidColorBrush), typeof(ToggleButtonOld2), new PropertyMetadata(Util.DammiBrushDaEsadec("F4F4F4")));
        ...
        public static readonly DependencyProperty ColoreBordoProperty = DependencyProperty.Register("ColoreBordo", typeof(SolidColorBrush), typeof(ToggleButtonOld2), new PropertyMetadata(Util.DammiBrushDaEsadec("EAEAEB")));
        ...
        public static readonly DependencyProperty ColoreBordoOnProperty = DependencyProperty.Register("ColoreBordoOn", typeof(SolidColorBrush), typeof(ToggleButtonOld2), new PropertyMetadata(Util.DammiBrushDaEsadec("41C955")));
        ...
        public static readonly DependencyProperty ColoreBordoDisabledProperty = DependencyProperty.Register("ColoreBordoDisabled", typeof(SolidColorBrush), typeof(ToggleButtonOld2), new PropertyMetadata(Util.DammiBrushDaEsadec("E5E5E5")));
        ...
        public static readonly DependencyProperty ColoreTestoOnProperty = DependencyProperty.Register("ColoreTestoOn", typeof(SolidColorBrush), typeof(ToggleButtonOld2), new PropertyMetadata(Util.DammiBrushDaEsadec("00AA00")));
        ...
        public static readonly DependencyProperty ColoreTestoDisabledProperty = DependencyProperty.Register("ColoreTestoDisabled", typeof(SolidColorBrush), typeof(ToggleButtonOld2), new PropertyMetadata(Brushes.LightGray));
        ...
        public static readonly DependencyProperty PrimaTestoProperty = DependencyProperty.Register("PrimaTesto", typeof(bool), typeof(ToggleButtonOld2), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty AddStyleProperty = DependencyProperty.Register("AddStyle", typeof(Style), typeof(ToggleButtonOld2), new PropertyMetadata(null));

        #endregion


        public ToggleButtonOld2()
        {
        ...
        private void MyLoaded(Object sender, RoutedEventArgs e)
        {
            ...
            this.Style = InizializzaAnimazioni(finalStyle);
        }
